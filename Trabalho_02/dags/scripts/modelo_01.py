...
with mlflow.start_run():
    ...
    predicted_qualities = gnb.predict(X_test)
    ...
    ## Salvando Modelo
    file = '/mnt/Dados/Documents/GitHub/mlops/trabalho_02/modelos/gnb.pickle'
    os.makedirs(os.path.dirname(file), exist_ok=True)
    with open(file, 'wb') as f:
        pickle.dump(gnb, f)

    if tracking_url_type_store != 'file':
        mlflow.sklearn.log_model(gnb, 'model', registered_model_name='model')
    else:
